...
<head>
    ...
    <title><?php echo e(config('app.name', 'Laravel')); ?> - Argenis Paolo Salazar Sihuay</title>
        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark shadow-sm ">
            <div class="container">
                <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
                    <?php echo e(config('app.name', 'Laravel')); ?> - Argenis Paolo Salazar Sihuay
                </a>
    ...
    <div class="container mt-5" >
        <div class="row justify-content-center">
            <div class="col-md-7 mt-5">
                ...
                <div class="row justify-content-center">
                    <a class="btn btn-dark btn-xs mt-5" href="<?php echo e(url ('/lista')); ?>">Ingresar a lista de estudiantes >></a>
                </div>
            </div>
        </div>
    </div>
</body>
</html><?php /**PATH D:\Tecsup3\Tecsup 3\Desarrollo de Aplicaciones en Internet\Sesion 12\Laboratorio 12\laboratorio12a\resources\views/layouts/app.blade.php ENDPATH**/ ?>